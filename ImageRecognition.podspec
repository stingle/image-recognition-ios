...
Pod::Spec.new do |spec|
  ...
  #  spec.description  = 'ImageRecognition is an object and face detection library.'
  ...
  spec.author             = "Stingle"
  # spec.authors            = { "Stingle" => "email@example.com" }
  # spec.social_media_url   = "https://twitter.com/stinlge"
  ...
  spec.source_files = 'ImageRecognition/Classes/**/*'
